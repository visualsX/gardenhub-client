...
export default function OrderListClient({ initialOrders, initialPageInfo, where, pageSize }) {
  ...
  return (
    <div className="space-y-5">
          ...
          return (
            ...
            >
              <div className="flex w-full flex-1 items-center gap-4">
                <div className="group-hover:bg-primary/5 group-hover:text-primary flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gray-50 text-gray-400 transition-colors">
                ...
                <div className="space-y-0.5">
                  <div className="flex flex-wrap items-center gap-3">
                    <h3 className="group-hover:text-primary text-sm font-bold text-gray-900 transition-colors">
                      Order {order.orderNumber}
                    </h3>
                    <span
                      className={`inline-flex items-center gap-1.5 rounded-full px-2 py-0.5 text-[9px] font-black tracking-tight uppercase ring-1 ring-inset ${status.color}`}
                    >
                      <span className={`h-1 w-1 rounded-full ${status.dot}`}></span>
                      {order.status}
                    </span>
                  </div>
                  <div className="flex items-center gap-1.5 text-[9px] font-bold tracking-widest text-gray-400 uppercase">
                    <svg
              ...
              <div className="flex w-full items-center justify-between gap-6 sm:w-auto">
                ...
                <div className="group-hover:bg-primary flex h-10 w-10 items-center justify-center rounded-full bg-gray-50 text-gray-400 transition-all duration-300 group-hover:text-white">
      ...
      {isError && (
        <div className="flex items-center gap-3 rounded-2xl bg-rose-50 p-4 text-sm font-semibold text-rose-700 ring-1 ring-rose-600/10 ring-inset">
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
