        ...
        addToCartMutation.mutate(
            {
                ...
                productInfo: {
                    id: product.id,
                    variantId: vs.selectedVariant?.id || 'no-variant',
                    name: product.name,
                    variant: variantName,
                ...
                <div className="p-2">
                    ...
                    <div className="flex items-center justify-between gap-4 border-t pt-6">
                        ...
                        <button
                            ...
                            className={`flex-1 rounded-full py-3 px-6 font-bold text-white shadow-lg transition-all active:scale-95 ${vs.canAddToCart && !addToCartMutation.isPending
