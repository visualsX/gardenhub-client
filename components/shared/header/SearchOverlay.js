...
export default function SearchOverlay({ open, onClose }) {
    ...
    const renderProductItem = (product) => (
        ...
        >
            ...
            <div className="flex-1">
                <h4 className="text-sm font-semibold text-primary-dark">{product.name}</h4>
    ...
    const renderCollectionItem = (collection) => (
        ...
        >
            ...
            <div className="flex-1">
                <h4 className="text-sm font-semibold text-primary-dark">{collection.name}</h4>
                                ...
                                items={[
                                    {
                                        ...
                                        label: `Products`,
                                        children: isLoading ? (
                                            <div className="py-12 text-center text-primary-dark">
                                                <div className="flex flex-col items-center gap-4">
                                                    <div className="relative h-12 w-12">
                                                        <div className="absolute inset-0 rounded-full border-2 border-primary/20"></div>
                                                        <div className="absolute inset-0 rounded-full border-t-2 border-primary animate-spin"></div>
                                                    </div>
                                                    <span className="text-sm font-medium animate-pulse">Searching products...</span>
                                                </div>
                                            </div>
                                        ...
                                        children: isLoading ? (
                                            <div className="py-12 text-center text-primary-dark">
                                                <div className="flex flex-col items-center gap-4">
                                                    ...
                                                    <span className="text-sm font-medium animate-pulse">Searching collections...</span>
                                                </div>
                                            </div>
