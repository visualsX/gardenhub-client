...
export default function QuantitySelector({
  ...
  const Loader = () => (
    <div className="absolute inset-0 flex items-center justify-center rounded-lg bg-white/50 transition-all duration-300">
  ...
  return (
    <div className={containerClasses}>
      ...
      <span className={`${textSize} font-outfit text-center font-black text-[#425d48]`}>
        {value}
      </span>
      <button
        onClick={() => onIncrement?.()}
