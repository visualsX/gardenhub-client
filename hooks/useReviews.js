...
export const useProductReviewStats = (productId) => {
    return useQuery({
        ...
        queryFn: async () => {
            const data = await graphqlClient.request(REVIEW_QUERIES.GET_PRODUCT_REVIEW_STATS, { productId });
...
export const useCanReviewProduct = (productId) => {
    return useQuery({
        ...
        queryFn: async () => {
            const data = await graphqlClient.request(REVIEW_QUERIES.GET_CAN_REVIEW_PRODUCT, { productId });
