 ...
 */
async function fetchShopProducts({ first = 12, after = null, where = null, order = null } = {}) {
  const variables = {
    first,
    after,
    where,
  ...
  const data = await graphQLClient.request(SHOP_QUERIES.SHOP_ALL_PRODUCTS, variables);
 ...
 */
export function useInfiniteShopProducts({ pageSize = 12, where = null, order = null } = {}) {
