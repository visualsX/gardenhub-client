            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
                {googleLoginMutation.isError ? (
                    <div className="text-red-600">
                        ...
                        <p className="mt-2 text-sm text-gray-500">{googleLoginMutation.error?.response?.data?.message || 'Authentication failed'}</p>
                        <Button
                            type="link"
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="text-gray-900 font-medium">Authenticating with Google...</p>
                    </div>
                )}
            </div>
        </div>
