    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-gray-50 p-6 pt-32">
            <Result
                ...
                icon={isOffline ? <WifiOutlined className="text-gray-400" style={{ fontSize: '64px' }} /> : null}
            ...
            >
                {!isOffline && (
                    <div className="text-left mt-8 rounded-lg bg-gray-100 p-4">
                        <Paragraph>
                            <Text strong className="text-red-600 block mb-2">Error Details:</Text>
