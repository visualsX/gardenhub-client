    ...
    const features = [
        {
            ...
            description: 'All our plants are carefully selected and nurtured to ensure they arrive healthy and thriving.',
            color: 'bg-primary'
        },
        {
            icon: <TruckIcon />,
            title: 'Fast Delivery',
            description: 'Quick and reliable delivery across the UAE, with same-day options available in select areas.',
            color: 'bg-primary'
        },
        {
            icon: <LightBulbIcon />,
            title: 'Expert Guidance',
            description: 'Our team is always ready to help you choose the right plants and provide care tips.',
            color: 'bg-primary'
        },
        {
            icon: <GlobeIcon />,
            title: 'Sustainable',
            description: 'We source from local farms and use eco-friendly packaging to minimize our environmental impact.',
            color: 'bg-primary'
        },
        {
            icon: <SparklesIcon />,
            title: 'Wide Selection',
            description: 'From easy-care succulents to statement indoor trees, we have plants for every space and skill level.',
            color: 'bg-primary'
        },
        {
            icon: <ShieldIcon />,
            ...
            <div className="max-layout">
                ...
                <section className="mb-16">
                    <div className="grid gap-6 md:grid-cols-2">
                        <div className="group relative overflow-hidden rounded-3xl bg-white border border-gray-300 p-8 transition-all hover:shadow-lg">
                            <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-primary/5"></div>
                            <div className="absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-primary/5"></div>
                ...
                <section className="mb-16">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="group rounded-2xl border border-gray-200 bg-white p-6 transition-all hover:border-primary hover:shadow-md"
                            >
                                <div className={`mb-4 inline-flex h-14 w-14 items-center justify-center rounded-xl ${feature.color} text-white transition-transform group-hover:rotate-6 group-hover:scale-110`}>
                                    {feature.icon}
                                </div>
                ...
                {/* Stats Section */}
                <section className="mb-16">
                    <div className="rounded-3xl bg-primary p-12 text-white">
                        <div className="grid gap-8 text-center md:grid-cols-3">
                            <div className="group">
                                <div className="mb-2 text-5xl font-bold transition-transform group-hover:scale-110">7000+</div>
                            ...
                            <div className="group">
                                <div className="mb-2 text-5xl font-bold transition-transform group-hover:scale-110">8+</div>
                ...
                <section className="mb-16">
                    <div className="mb-8 text-center">
                        ...
                        <p className="mx-auto max-w-2xl text-lg text-gray-600">
                            The passionate people behind GardenHub, dedicated to bringing you the best plants and service
                        </p>
                    </div>
                ...
                <section className="text-center">
                    <div className="rounded-3xl border border-gray-300 bg-white p-12">
                        <h2 className="mb-4 text-3xl font-bold sm:text-4xl text-primary">Ready to Start Your Green Journey?</h2>
                        <p className="mb-8 text-lg text-black">
                            Explore our collection and find the perfect plants for your space.
                        </p>
                        <Link
                            href="/shop"
                            className="inline-flex items-center gap-2 rounded-full bg-primary! px-8 py-4 font-semibold text-white! shadow-lg transition-all hover:scale-105 hover:bg-primary-dark! hover:shadow-xl!"
                        >
                            Shop Now
                            <svg
                                width="20"
