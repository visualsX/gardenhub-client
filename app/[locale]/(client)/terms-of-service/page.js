      ...
      <div className="max-layout">
        ...
        <div className="mx-auto max-w-4xl">
          <div className="space-y-6">
            ...
            >
              <p className="mb-4 text-base leading-relaxed">By using our website, you agree to:</p>
              <PolicyList
                items={[
            ...
            >
              <p className="mb-4 text-base leading-relaxed">When you place an order:</p>
              <PolicyList
                items={[
            ...
            >
              <p className="mb-4 text-base leading-relaxed">
                ...
                is the property of GardenHub and is protected by copyright and other intellectual
            ...
            >
              <p className="text-base leading-relaxed">
                ...
                United Arab Emirates. Any disputes shall be subject to the exclusive jurisdiction of
