import PolicySection, {
  ...
  PolicyGrid,
  PolicyContact,
} from '@/components/shared/PolicySection';
          ...
          <div className="space-y-6">
            ...
            >
              <p className="mb-4 text-base leading-relaxed">
                You have 14 days from the date of delivery to return eligible items. To be eligible
            ...
            >
              <p className="mb-4 text-base leading-relaxed">
                While live plants are generally not eligible for return, we guarantee that your
                plants will arrive healthy and in good condition. If your plant arrives damaged or
                unhealthy:
              </p>
              <PolicyList
                items={[
            ...
            >
              <p className="mb-4 text-base leading-relaxed">
                ...
                business days. Refunds will be issued to your original payment method. Please note:
              </p>
              <PolicyList
                items={[
            ...
            >
              <p className="text-base leading-relaxed">
                We currently do not offer direct exchanges. If you need a different item, please
