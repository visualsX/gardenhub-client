            ...
            <form className="space-y-6">
              <div>
                ...
                <input
                  type="text"
                  id="name"
                  className="focus:border-primary focus:ring-primary w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-gray-900 focus:ring-1 focus:outline-none"
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+971XXXXXXXX" className="hover:text-primary! text-gray-600!">
                      +971 XX XXX XXXX
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-primary-dark rounded-3xl p-8 text-white">
              ...
              <p className="mb-4 text-gray-300">
                Check out our FAQ page for instant answers to common questions about orders,
                shipping, and plant care.
              </p>
              <Link
                href="/faq"
                className="text-primary! inline-flex items-center gap-2 rounded-full bg-white! px-6! py-2.5! font-semibold transition-colors hover:bg-gray-100!"
              >
                Visit FAQ
                <svg
                  width="16"
