                        ...
                        >
                            ...
                            <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                {['Dubai', 'Abu Dhabi', 'Sharjah', 'Ajman', 'Ras Al Khaimah', 'Fujairah', 'Umm Al Quwain'].map((city) => (
                                    <div key={city} className="flex items-center gap-2 rounded-lg bg-green-50 px-3 py-2">
                        ...
                        >
                            <div className="grid gap-4 md:grid-cols-3">
                                <div className="rounded-xl bg-green-50 p-4">
                                    ...
                                    <p className="text-sm text-gray-600">2-4 business days from order confirmation.</p>
                                </div>
                                <div className="rounded-xl bg-green-50 p-4">
